...
@Component({
  selector: 'app-customer-toolbar-counsellor',
  templateUrl: './customer-toolbar-counsellor.component.html',
  styleUrls: ['./customer-toolbar-counsellor.component.scss'],
})
export class CustomerToolbarCounsellorComponent implements OnInit {
  count = 0;
