...
export class OnBreakComponent  implements OnInit {
  ...
  id:any;
  lastLoginDate:any;
  constructor(private popoverController:PopoverController,private api:ApiService,private _fb:FormBuilder,private router:Router,private datePipe:DatePipe) { }
